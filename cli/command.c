...
sw_command_t shell_main_conf[] = {
	{"terminal",			1,	cmd_conf_t,				"Configure from the terminal",						NULL},
	{(char *)NULL, 0, (rl_icpfunc_t *) NULL, (char *) NULL, (sw_command_t *) NULL}
};

sw_command_t shell_main[] = {
	{"clear",				0,	NULL, 					"Reset functions",									NULL},
	{"configure",			1,	NULL,					"Enter configuration mode",							shell_main_conf},
	...
	{"quit",				0,	cmd_exit,				"Exit from the EXEC",								NULL},
