cmd_net/switch/sw_fdb.o := gcc -m32 -Wp,-MD,net/switch/.sw_fdb.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/3.4.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -pipe -msoft-float -mpreferred-stack-boundary=2 -fno-unit-at-a-time -march=i586 -fno-optimize-sibling-calls -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement  -DNET_SWITCH_NOVLANFORIF=1  -DMODULE -DKBUILD_BASENAME=sw_fdb -DKBUILD_MODNAME=switch -c -o net/switch/.tmp_sw_fdb.o net/switch/sw_fdb.c

deps_net/switch/sw_fdb.o := \
  net/switch/sw_fdb.c \
...
net/switch/sw_fdb.o: $(deps_net/switch/sw_fdb.o)
