cmd_net/switch/sw_vdb.o := gcc -m32 -Wp,-MD,net/switch/.sw_vdb.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/3.4.2/include -D__KERNEL__ -Iinclude  -include include/linux/autoconf.h -Wall -Wundef -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fno-omit-frame-pointer -fno-optimize-sibling-calls -g -pipe -msoft-float -mpreferred-stack-boundary=2 -fno-unit-at-a-time -march=i586 -fno-optimize-sibling-calls -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement  -DNET_SWITCH_NOVLANFORIF=1  -DMODULE -DKBUILD_BASENAME=sw_vdb -DKBUILD_MODNAME=switch -c -o net/switch/.tmp_sw_vdb.o net/switch/sw_vdb.c

deps_net/switch/sw_vdb.o := \
  net/switch/sw_vdb.c \
...
net/switch/sw_vdb.o: $(deps_net/switch/sw_vdb.o)
